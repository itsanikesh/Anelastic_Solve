...
module mgVARS
 ...
 real(r8),allocatable,dimension(:)           :: workc1, workc2, workc3, workc4, workc5, workc6, workc7, work1, work2 !WORK arrays for the solver work1=solution work2=source
 ...
 integer(i4),allocatable,dimension(:)        :: kp3d, kpx1, kpx2, kpx3, kpbgn, kcbgn !3d and 1d offsets in 1d arrays
 integer(i4)                                 :: nwork3d,nworkx1,nworkx2,nworkx3,nwork  !size of 1d arrays
