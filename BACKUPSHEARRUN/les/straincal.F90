...
#ifdef PARALLEL
 !Make sure that the global max is used on all nodes
 call MPI_ALLREDUCE(Ltmp,Gtmp,1,realtype,MPI_MAX,comm3d,err)
#endif
 varMax=Gtmp
...
!CALCULATE minimum nappa_sgs
 ...
 call MPI_ALLREDUCE(Ltmp,Gtmp,1,realtype,MPI_MIN,comm3d,err)
#endif
 varMin=Gtmp  
 stat = err
 return
