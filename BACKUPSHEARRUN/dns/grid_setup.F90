...
! dxi_min=min(dx1_min,dx2_min,dx3_min)
 ...
 call MPI_ALLREDUCE(dx1_min,Ddt,1,realtype,MPI_MIN,comm3d,err1)
 dx1_min=Ddt
 call MPI_ALLREDUCE(dx2_min,Ddt,1,realtype,MPI_MIN,comm3d,err1)
 dx2_min=Ddt
 call MPI_ALLREDUCE(dx3_min,Ddt,1,realtype,MPI_MIN,comm3d,err1)
 dx3_min=Ddt
#endif
 Ddt=0.125d0/rRe&
