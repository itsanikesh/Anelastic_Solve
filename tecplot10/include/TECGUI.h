...
#ifndef _TECGLBL_H
#error "Include TECGLBL.h before TECGUI.h"
#endif
 ...
 *   
 * @param MakeTopmost
 *   Set to TRUE to make the dialog the topmost or FALSE to leave it's stacking
 *   order unchanged
 *   
 * <FortranSyntax>
...
/**
 * @deprecated
 *   Please use TecGUIDialogSetPosition() instead.
 */
...
/**
 * @deprecated
 *   Please use TecGUIDialogSetPositionX() instead.
 */
 ...
 *   
 * @param TextFieldName
 *   Name of the attributes represented by the text field. This name is used in error message of the
 *   value is not within the specified domain. If this value is NULL no error message is presented
 *   
 * @param MinDomain
 *   Minimum acceptable domain for the value
...
LINKTOADDON Boolean_t STDCALL TecGUITextFieldValidateDouble(LgIndex_t   TextFieldID,
                                                            ...
                                                            double      MaxDomain);
/**
 *   Gets the set represented by the contents of the text field. A set is made of comma separated
 *   members that may optionally have outer square brackets. Each set member may be one of the
 *   following: a positive number, or a number range of the form n-m:s where n is the starting value,
 *   m is the ending value. The :s notation is an optional skip value. The following set defines the
 ...
 *   
 * @param UseMx
 *   Indicates of Mx syntax should be used. If TRUE then values less than or equal to zero are replaced
 *   with Mx syntax: Mx or Mx-n where n is a positive number. If the Value is zero Mx is used, -1
 *   indicates Mx-1 is used and so forth.
 *   
 * <FortranSyntax>
