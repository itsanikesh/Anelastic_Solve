...
GLTTGlyphPolygonizerHandler* GLTTGlyphPolygonizer::default_handler= 0;

GLTTGlyphPolygonizerHandler* GLTTGlyphPolygonizer::getDefaultHandler(void)
{
  if( default_handler == 0 )
    default_handler = new GLTTGlyphPolygonizerHandler();
...
void GLTTGlyphPolygonizer::deleteDefaultHandler(void)
{
  if( default_handler != 0 )
    {
