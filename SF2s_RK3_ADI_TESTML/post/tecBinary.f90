...
subroutine write_aux_details_zone(ss1)
!Used to write auxiliary data to a tecplot binary file
 implicit none
                                                             
!Passed Variables
 character(len=100),intent(in)     :: ss1

!Local Variables
 integer                           :: TeczAuxStr100,IRES
 character,parameter               :: NULLCHR = CHAR(0)

  IRES   = TeczAuxStr100("tval"//NULLCHR,trim(ss1)//NULLCHR)

 return
end subroutine write_aux_details_zone


subroutine write_aux_details(ss1)
!Used to write auxiliary data to a tecplot bindary file
 implicit none
...
!Local Variables
 integer                           :: TecAuxStr100,IRES
 character,parameter               :: NULLCHR = CHAR(0)

  IRES   = TecAuxStr100("tval"//NULLCHR,trim(ss1)//NULLCHR)

 return
end subroutine write_aux_details
