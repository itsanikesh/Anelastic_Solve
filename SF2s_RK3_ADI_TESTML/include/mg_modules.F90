...
#ifdef PARALLEL
 use dd,       only: realtype, inttype, comm3d, nxprocs, nyprocs, nzprocs, &
                     MPI_DATATYPE_NULL, MPI_MAX,&
                     MPI_SUM, MPI_STATUS_SIZE, neighbor, &
                     nbrx1m1, nbrx1p1, nbrx2m1, nbrx2p1,  nbrx3m1, nbrx3p1  
#endif
...
module mgVARS
 ...
 integer(8)                                :: MPIxstride                       !MPItype for hvector, NEEDED STILL???
