...
module dd
 ...
 integer(i4),parameter      :: smpistatus=MPI_STATUS_SIZE
 ...
 integer(i4)                :: nbrx1m1,nbrx1p1,nbrx2m1,nbrx2p1,nbrx3m1,nbrx3p1 
 ...
 !SIZES
 integer(i4)  :: sizex1,sizex2,sizex3,sizex1x2,sizex2x3,sizex1x3,sizeX1X2X3
